...
export default class Settings {
  ...
  public createGutterBracketDecorations(color: string, bracket: string): vscode.TextEditorDecorationType {
  ...
  public createRulerBracketDecorations(color: string): vscode.TextEditorDecorationType {
    const decorationSettings: vscode.DecorationRenderOptions = {
  ...
  public createScopeBracketDecorations(color: string): vscode.TextEditorDecorationType {
    const decorationSettings: vscode.DecorationRenderOptions = {
